...
export default Factory.extend({
    id: () => Buffer.from([`5d79109d167e923a83d3d7db_$_cc=${faker.random.uuid()}`, 'mv=5d79109d167e923a83d3d7dd', 'pi=cmp'].join('&')).toString('base64'),
    v: false,
    cl: false,
    p: true,
    db: false,
    ...
    tp: 'short_news',
    ar: 1,
    // i: `https://picsum.photos/seed/${this.e.custom_card_type}_i/384/216?blur=3`,
    u: null,
    uw: null,
    tt: () => faker.lorem.sentence(),
    ds: faker.lorem.sentence(),
    dm: faker.internet.domainName()
});
